...
Event.create!(:group_id => 1, :date => DateTime.new(2021, 1, 1), :theme_id => 1, :name => "Horror Extravaganza!", :user_id => 1, :voting_open? => false)
Event.create!(:group_id => 1, :date => DateTime.new(2021, 2, 1), :theme_id => 2, :name => "Sorry Not Sorry", :user_id => 2, :voting_open? => true)
Event.create!(:group_id => 2, :date => DateTime.new(2021, 1, 15), :theme_id => 4, :name => "Pew Pew", :user_id => 4, :voting_open? => false)
Event.create!(:group_id => 3, :date => DateTime.new(2021, 3, 15), :theme_id => 5, :name => "I'm Shaking in my Boots", :user_id => 5, :voting_open? => true)
Event.create!(:group_id => 2, :date => DateTime.new(2021, 4, 1), :theme_id => 3, :name => "Awwwwww", :user_id => 1, :voting_open? => true)
